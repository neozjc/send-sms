...
$(function () {
    ...
    function c() {
        ...
        if (k) {
            ...
            var p = '<a href="javascript:;" class="active J_menuTab" data-id="' + o + '"><i class="fa fa-refresh J_refresh"></i> ' + l + ' <i class="fa fa-times-circle J_close"></i></a>';
    ...
    $(".J_menuTabs").on("click", ".J_menuTab .J_close", h);


    function i() {

        $(".page-tabs-content").children("[data-id]").not(":first").not(".active").each(function () { $('.J_iframe[data-id="' + $(this).data("id") + '"]').remove(); $(this).remove() }); $(".page-tabs-content").css("margin-left", "0")
    ...
    function dd() {
        var tab = $(this).parents(".J_menuTab");
        var l = $('.J_iframe[data-id="' + tab.data("id") + '"]');
        l.attr('src', l.attr('src'));
    }

    $(".J_menuTabs").on("click", ".J_menuTab .J_refresh", dd);
